...
class SyncCarrierEcontOffices extends Command
{
    ...
    protected $signature = 'econt:sync-offices
                            {--timeout=2000 : Econt API Call timeout}
