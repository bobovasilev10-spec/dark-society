        ...
        <footer className="ds-footer">
            <div className="ds-footer-top">
                ...
                <div className="ds-footer-links">
                    ...
                    <div><h3>Информация</h3><a href="/about-us">За бранда</a><a href="/privacy-policy">Лични данни</a><a href="/terms-of-use">Общи условия</a></div>
                ...
                <div className="ds-footer-social">
                    ...
                    <div><a href="https://www.instagram.com/darksociety.wear" aria-label="Instagram"><i className="fa-brands fa-instagram"></i></a><a href="https://www.tiktok.com/@darksociety.wear" aria-label="TikTok"><i className="fa-brands fa-tiktok"></i></a><a href="#" aria-label="Facebook"><i className="fa-brands fa-facebook-f"></i></a></div>
                </div>
            </div>
